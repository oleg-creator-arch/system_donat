...
export const Contact = () => {
  return (
    ...
    >
      ...
      >
        © 2025 ИНН: 1655031361 МЕСТНАЯ МУСУЛЬМАНСКАЯ РЕЛИГИОЗНАЯ ОРГАНИЗАЦИЯ-ПРИХОД ЗАКАБАННОЙ
        МЕЧЕТИ ИМЕНИ 1000-ЛЕТИЯ ПРИНЯТИЯ ИСЛАМА МУХТАСИБАТА ВАХИТОВСКОГО И ПРИВОЛЖСКОГО РАЙОНОВ Г.
        КАЗАНИ ЦЕНТРАЛИЗОВАННОЙ РЕЛИГИОЗНОЙ ОРГАНИЗАЦИИ — ДУХОВНОГО УПРАВЛЕНИЯ МУСУЛЬМАН РЕСПУБЛИКИ
        ТАТАРСТАН
      </Typography>
    </Box>
  );
